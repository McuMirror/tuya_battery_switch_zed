...
- 1.0.05
	...
	- Добавлена возможность перезапустить выключатель. Для этого нужно нажать быстро 10 раз подряд любую кнопку.
...
- 1.0.06
	...
	- Добвлена возможность менять температуру цвета ламп CCT.
